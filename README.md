...
- **Figure 1.2-4:** [Example data from the Global SDGs Indicators Database](/figures/1.2-4.pdf)
...
- **Figure 1.8-2:** [The effects of the modifiable areal unit problem and the ecological fallacy](/figures/1.8-2.pdf)
	- **Data:** [Indicator 15.1.1 (2015)](/data/1.8/15.1.1_2015_Data.csv)
...
- **Figure 2.1-1:** Content selection
	...
	- **Data:** [Indicator 6.1.1 (2016)](/data/2.1/6.1.1_2015_Data.csv)
...
- **Figure 2.3-1:** [Cartographic design decisions](/figures/2.3-1.pdf)
	- **Data:** [Indicator 6.1.1 (2016)](/data/2.3/6.1.1_2015_Data.csv)
...
- **Figure 2.5-1:** [Projection centring](/figures/2.5-1.pdf)
	- **Data:** [Indicator 6.4.2 (2015)](/data/2.5/6.4.2_2015_Data.csv)
...
- **Figure 2.6-1:** [Indicators of scale](/figures/2.6-1.pdf)
	- **Data:** [Indicator 6.4.2 (2015)](/data/2.6/6.4.2_2015_Data.csv)
...
- **Figure 2.7-1:** [Simplification](/figures/2.7-1.pdf)
	- **Data:** [Indicator 5.5.1 (2019)](/data/2.7/5.5.1_2019_Data.csv)
...
- **Figure 2.8-2:** [Perceptual effects on symbol dimensionality](/figures/2.8-2.pdf)
	- **Data:** [Indicator 4.b.1 (2009)](/data/2.8/4.b.1_2009_Data.csv)
...
- **Figure 2.10-2:** [Sequential colour scheme](/figures/2.10-2.pdf)
	- **Data:** [Indicator 8.1.1 (2016)](/data/2.10/8.1.1_2016_Data.csv)
...
- **Figure 2.11-1:** [Autolabelling in mapping software](/figures/2.11-1.pdf)
- **Figure 2.11-2:** [Improved labelling](/figures/2.11-2.pdf)
- **Figure 2.12-1:** [Typonymy](/figures/2.12-1.pdf)
- **Figure 2.13-1:** [Map layout](/figures/2.13-1.pdf)
	- **Data:** [Indicator 6.2.1 (2015)](/data/2.13/6.2.1_All_Data.csv)
- **Figure 2.13-2:** [Visual hierarchy](/figures/2.13-2.pdf)
	- **Data:** [Indicator 6.2.1 (2015)](/data/2.13/6.2.1_All_Data.csv)
- **Figure 2.14-1:** Visual styles in four web basemaps
	- **Top Left:** [OpenStreetMap Mapnik](/figures/2.14-1a.jpg)
	- **Top Right:** [Esri World Light Gray Canvas](/figures/2.14-1b.jpg)
	- **Bottom Left:** [CARTO Dark Matter](/figures/2.14-1c.jpg)
	- **Bottom Right:** [Stamen Watercolor](/figures/2.14-1d.jpg)
- **Figure 2.14-2:** Visual styles and emotion
	- **Top:** [The minimalist, authoritative style includes detailed linework and a soft colour palette](/figures/2.14-1.pdf)
	- **Bottom:** [The alternative, creative style includes angular linework and bold colours against a black background](/figures/2.14-2.pdf)
	- **Data:** [Indicator 12.c.1 (2017)](/data/2.14/12.c.1_2017_Data.csv)
- **Figure 2.15-1:** [Missing data versus zero](/figures/2.15-1.pdf)
	- **Data: Currently Unavailable**
...
- **Figure 3.1-1:** Thematic map types
	- **Data:** [Indicator 12.2.2 (2016)](/data/3.1/12.2.2_2016_Data.csv)
...
- **Figure 3.2-1:** [Binary nominal map](/figures/3.2-1.pdf)
	- **Data:** [Indicator 15.6.1 (2016)](/data/3.2/15.6.1_2016_Data.csv)
- **Figure 3.3-1:** [Choropleth map](/figures/3.3-1.pdf)
	- **Data:** [Indicator 16.3.2 (2017)](/data/3.3/16.3.2_2017_Data.csv)
	- [Legend](/figures/3.3-1_legend.pdf)
- **Figure 3.4-1:** [Proportional symbol map](/figures/3.4-1.pdf)
	- **Data:** [Indicator 3.2.1 (2016)](/data/3.4/3.2.1_2015_Data.csv)
...
- **Figure 3.5-2:** [Exclusionary data](/figures/3.5-2.pdf)
	- **Data:** [Indicator 15.2.1 (2018)](/data/3.5/15.2.1_2018_Data.csv)
...
- **Figure 3.7-2:** [Separable bivariate map](/figures/3.7-2.pdf)
	- **Data:** [Indicator 4.3.1 (2016)](/data/3.7/4.3.1_2016_Data.csv) and [Indicator 5.5.2 (2016)](/data/3.7/5.5.2_2016_Data.csv)
...
- **Figure 3.8-2:** [Types of cartograms](/figures/3.8-2.pdf)
	- **Data:** [Indicator 4.b.1 (2018)](/data/3.8/4.b.1_2018_Data.csv)
	- [Legend](/figures/3.8-2_legend.pdf)
- **Figure 3.9-1:** [Small multiples of a time series](/figures/3.9-1.pdf)
	- **Data:** [Indicator 7.2.1 (2000-2015)](/data/3.9/7.2.1_2000to2015_Data.csv)
...
- **Figure 4.2-1:** [Suboptimal design for visual impairment](/figures/4.2-1.pdf)
	- **Data:** [Indicator 17.10.1 (2018)](/data/4.2/17.10.1_MultipleYears_Data.csv)
...
- **Figure 4.3-1:** [Recommendations for non-mobile cartographic interface design](/figures/4.3-1.pdf)
	- **Data:** [Indicator 7.1.1 (2017)](/data/4.3/7.1.1_2017_Data.csv)
...
- **Figure 4.6-1:** Recommendations for responsive cartographic representation and interface design
	...
	- **Data:** [Indicator 12.c.1 (2017)](/data/4.6/12.c.1_2017_Data.csv)
...
- **Figure 4.8-2:** [Interacting with time](/figures/4.8-2.pdf)
	- **Data:** [Indicator 16.10.2 (2000-2020)](/data/4.8/16.10.2_2000to2020_Data.csv)
...
- **Figure 4.11-2:** [Interactive atlas](/figures/4.11-2.pdf)
	- **Data:** [Indicator 15.1.1 (2015)](/data/4.11/15.1.1_2015_Data.csv)
